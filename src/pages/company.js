...
export default function company() {
  ...
  return (
    <>
      ...
      <section className="py-12 px-8 md:px-16 lg:px-24 xl:px-43 flex  text-justify flex-col md:flex-row items-center gap-8">
        ...
        <div className="md:w-1/2 pb-16">
          <div>
            <h1 className="text-3xl font-bold text-[var(--color-primary)] ] text-justify ">Our Vision</h1>
          ...
          <div className="mt-14 text-justify">
            <h1 className="text-3xl font-bold text-[var(--color-primary)] ]">Our Mission</h1>
      ...
      <section className="bg-white py-6 px-8 md:px-16 lg:px-24 xl:px-43 flex flex-col md:flex-row items-center text-justify justify-between ">
        <div className="md:w-2/3">
          <h2 className="text-3xl font-bold text-[var(--color-primary)]">Sustainability</h2>
