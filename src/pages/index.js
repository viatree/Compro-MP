  ...
  return (
    <>
      ...
      <section className="relative w-full h-screen items-center mt-20">
        ...
        {/* Hero Content */}
        <div className="relative z-10 flex flex-col justify-center text-center text-white h-full px-6 ">
          ...
          <p className="mt-2 mb-4 text-sm md:text-base font-extrabold drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)]">
            ISO 9001 Certified • FSC® Certified • Halal Certified
          </p>
          <Link href="/solutions">
            <button className=" bg-[var(--color-primary)] hover:bg-[var(--color-darker)] transition-all duration-300 text-white font-semibold text-lg px-6 py-3 rounded-md shadow-lg cursor-pointer">
      ...
      <section className="py-6 px-8 md:px-16 lg:px-24 xl:px-43">
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-[var(--color-text)]">
            End-to-end service for seamless project execution
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-8 md:px-16 lg:px-24 xl:px-43">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Link href="/solutions" className="block h-full group">
            <div className="relative flex flex-col h-full transition duration-300  hover:brightness-80 ">
              <img
